...
This is my game (well, sort-of) for the 2017 Global Game Jam. Visit my [game page](http://globalgamejam.org/2017/games/tale-stone-children-live-earth-and-maiden-soothed-world) for more information.

## Building this project
In order to build this project you will need:

0. Visual Studio 2015 Update 3, plain vanilla install (not customized)
1. Unity3D version 5.5.0f3, with the Windows 10 Universal plugin (will prompt you to download if you don't have it)
2. HoloLens Toolkit version 1.5.5.0
3. Blender 2.78a
...
2. The [HoloToolkit for Unity](https://github.com/Microsoft/HoloToolkit-Unity/releases/tag/v1.5.5.0) is by Microsoft, and is licensed under the MIT license.
3. The [TriplanarWorld.shader](https://gist.github.com/radiatoryang/4725041) is by Robert Yang.
